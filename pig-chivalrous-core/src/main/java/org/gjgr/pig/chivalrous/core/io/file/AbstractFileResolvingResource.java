...
public abstract class AbstractFileResolvingResource extends AbstractResource {
    ...
    public boolean isFile() {
        try {
            ...
            return FileCommand.URL_PROTOCOL_FILE.equals(url.getProtocol());
        } catch (IOException ex) {
            return false;
        }
    }
    ...
    public long lastModified() throws IOException {
        URL url = getURL();
        if (FileCommand.isFileURL(url) || FileCommand.isJarURL(url)) {
            // Proceed with file system resolution
            try {
    ...
    protected File getFileForLastModifiedCheck() throws IOException {
        URL url = getURL();
        if (FileCommand.isJarURL(url)) {
            URL actualUrl = FileCommand.extractArchiveURL(url);
    ...
    protected boolean isFile(URI uri) {
        try {
            ...
            return FileCommand.URL_PROTOCOL_FILE.equals(uri.getScheme());
        } catch (IOException ex) {
            return false;
        }
    }
     ...
     * file in the file system.
     *
     * @sees org.springframework.util.ResourceUtils#getFile(URI, String)
     */
    ...
    protected void customizeConnection(URLConnection con) throws IOException {
        FileCommand.useCachesIfNecessary(con);
