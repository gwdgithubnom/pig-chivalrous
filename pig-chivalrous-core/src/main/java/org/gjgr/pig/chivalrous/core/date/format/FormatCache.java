...
abstract class FormatCache<F extends Format> {
    ...
    /**
     * <p>
     * Gets a dateTime/time format for the specified styles and locale.
     * </p>
     *
     * @param dateStyle dateTime style: FULL, LONG, MEDIUM, or SHORT, null indicates no dateTime in format
     * @param timeStyle time style: FULL, LONG, MEDIUM, or SHORT, null indicates no time in format
     * @param locale    The non-null locale of the desired format
     * @return a localized standard dateTime/time format
    ...
    static String getPatternForStyle(final Integer dateStyle, final Integer timeStyle, final Locale locale) {
        ...
        if (pattern == null) {
            try {
                ...
                throw new IllegalArgumentException("No dateTime time pattern for locale: " + locale);
            }
        }
        return pattern;
    }
     ...
     *
     * @return a dateTime/time formatter
     */
    ...
    /**
     * <p>
     * Gets a dateTime/time formatter instance using the specified style, time zone and locale.
     * </p>
     *
     * @param dateStyle dateTime style: FULL, LONG, MEDIUM, or SHORT, null indicates no dateTime in format
     * @param timeStyle time style: FULL, LONG, MEDIUM, or SHORT, null indicates no time in format
     * @param timeZone  optional time zone, overrides time zone of formatted dateTime, null means use default Locale
     * @param locale    optional locale, overrides system locale
     * @return a localized standard dateTime/time formatter
     * @throws IllegalArgumentException if the Locale has no dateTime/time pattern defined
     */
     ...
     * @throws IllegalArgumentException if the Locale has no dateTime/time pattern defined
     */
    // package protected, for access from DateTimeFormatter; do not make public or protected
    ...
    /**
     * <p>
     * Gets a dateTime formatter instance using the specified style, time zone and locale.
     * </p>
     *
     * @param dateStyle dateTime style: FULL, LONG, MEDIUM, or SHORT
     * @param timeZone  optional time zone, overrides time zone of formatted dateTime, null means use default Locale
