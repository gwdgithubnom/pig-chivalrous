...
public class ConvertTest {
    ...
    public void hexTest() {
        ...
        String hex = Convert.toHex(a, CharsetCommand.CHARSET_UTF_8);
        Assert.assertEquals("e68891e698afe4b880e4b8aae5b08fe5b08fe79a84e58fafe788b1e79a84e5ad97e7aca6e4b8b2", hex);

        String raw = Convert.hexStrToStr(hex, CharsetCommand.CHARSET_UTF_8);
    ...
    public void convertCharsetTest() {
        String a = "我不是乱码";
        // 转换后result为乱码
        String result = Convert.convertCharset(a, CharsetCommand.UTF_8, CharsetCommand.ISO_8859_1);
        String raw = Convert.convertCharset(result, CharsetCommand.ISO_8859_1, "UTF-8");
        Assert.assertEquals(raw, a);
    }
