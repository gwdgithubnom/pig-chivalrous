...
public class SymmetricTest {
    ...
    public void aesTest() {
        ...
        Assert.assertEquals(content, StringCommand.str(decrypt, CharsetCommand.CHARSET_UTF_8));

        // 加密为16进制表示
        String encryptHex = aes.encryptHex(content);
        // 解密为字符串
        String decryptStr = aes.decryptStr(encryptHex, CharsetCommand.CHARSET_UTF_8);
    ...
    public void desTest() {
        ...
        String decryptStr = des.decryptStr(encryptHex, CharsetCommand.CHARSET_UTF_8);
