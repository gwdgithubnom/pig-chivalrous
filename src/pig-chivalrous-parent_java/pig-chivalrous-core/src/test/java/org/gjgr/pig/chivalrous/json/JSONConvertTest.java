...
public class JSONConvertTest {
	...
	public void testBean2Json() {
		...
		JSONObject obj = JsonUtil.jsonObject(tempMap);
	...
	public void testJson2Bean() {
		...
		JSONObject jsonObject = JsonUtil.jsonObject(examJson).getJSONObject("examInfoDicts");
		UserInfoDict userInfoDict = jsonObject.bean(UserInfoDict.class);
