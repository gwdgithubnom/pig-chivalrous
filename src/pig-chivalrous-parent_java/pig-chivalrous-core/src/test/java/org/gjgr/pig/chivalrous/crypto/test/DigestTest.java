...
public class DigestTest {
    ...
    public void md5Test() {
        ...
        String md5Hex2 = DigestUtil.md5Hex(IoCommand.toStream(testStr, CharsetUtil.CHARSET_UTF_8));
    ...
    public void sha1Test() {
        ...
        String sha1Hex2 = DigestUtil.sha1Hex(IoCommand.toStream(testStr, CharsetUtil.CHARSET_UTF_8));
