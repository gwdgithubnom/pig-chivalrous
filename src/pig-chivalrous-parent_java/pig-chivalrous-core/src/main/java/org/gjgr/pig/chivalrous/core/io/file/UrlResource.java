...
public class UrlResource extends AbstractFileResolvingResource {
    ...
    private URL getCleanedUrl(URL originalUrl, String originalPath) {
        try {
            return new URL(LocationCommand.cleanPath(originalPath));
    ...
    /**
     * This implementation creates a {@code UrlResource}, applying the given path relative to the path of the underlying
     * URL of this resource descriptor.
     *
    ...
    public String getFilename() {
        return FileCommand.filename(this.cleanedUrl.getPath());
    }
