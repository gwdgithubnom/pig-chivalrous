 ...
 *
 * @see SimpleDateTimeParser
 * @since 2.16.2
 */
class SimpleDateTimePrinter extends AbstractDateTime implements DateTimePrinter {
    ...
    public <B extends Appendable> B format(Calendar calendar, final B buf) {
        // do not pass in calendar directly, this will cause TimeZone of SimpleDateTimePrinter to be ignored
