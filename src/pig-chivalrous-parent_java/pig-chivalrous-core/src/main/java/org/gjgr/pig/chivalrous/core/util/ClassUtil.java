...
public final class ClassUtil {
     ...
     *
     * @param <T>
     * @param classNameDotMethodName 类名和方法名表达式，例如：org.gjgr.tools.StrUtil.isEmpty
     ...
     *
     * @param <T>
     * @param classNameWithMethodName 类名和方法名表达式，例如：org.gjgr.tools.StrUtil#isEmpty或org.gjgr.tools.StrUtil.isEmpty
     ...
     * 获得给定类所在包的路径<br>
     * 例如：<br>
     * ClassUtil -> com/xiaoleilu/hutool/util
     *
     * @param clazz 类
     * @return 包名
     */
