...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public boolean remove(Object key, final Object value) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) {
            ...
            protected Boolean execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry) {
                if (entry != null && ObjectCommand.nullSafeEquals(entry.getValue(), value)) {
                    if (ref != null) {
                        ref.release();
                    }
                    return true;
    ...
    public boolean replace(K key, final V oldValue, final V newValue) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY) {
            @Override
            protected Boolean execute(@Nullable Reference<K, V> ref, @Nullable Entry<K, V> entry) {
                if (entry != null && ObjectCommand.nullSafeEquals(entry.getValue(), oldValue)) {
    ...
    public boolean containsKey(@Nullable Object key) {
        Entry<K, V> entry = getEntryIfAvailable(key);
        return (entry != null && ObjectCommand.nullSafeEquals(entry.getKey(), key));
    }
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final int hashCode() {
            return (ObjectCommand.nullSafeHashCode(this.key) ^ ObjectCommand.nullSafeHashCode(this.value));
        }
        ...
        public final boolean equals(Object other) {
            ...
            return (ObjectCommand.nullSafeEquals(getKey(), otherEntry.getKey()) &&
                    ObjectCommand.nullSafeEquals(getValue(), otherEntry.getValue()));
        }
            ...
            while (currRef != null) {
                if (currRef.getHash() == hash) {
                    ...
                    if (entry != null) {
                        ...
                        if (ObjectCommand.nullSafeEquals(entryKey, key)) {
                            return currRef;
                        }
                    }
                }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(@Nullable Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                if (otherEntry != null) {
                    return ObjectCommand.nullSafeEquals(otherEntry.getValue(), otherEntry.getValue());
                }
            }
            return false;
        }
