...
public class HexCommand {
    ...
    public static char[] encodeHex(String str, Charset charset) {
        return encodeHex(StringCommand.bytes(str, charset), true);
    }
    ...
    public static String encodeHexStr(String data, Charset charset) {
        return encodeHexStr(StringCommand.bytes(data, charset), true);
    }
    ...
    public static String encodeHexStr(String data) {
        return encodeHexStr(data, CharsetCommand.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr) {
        return decodeHexStr(hexStr, CharsetCommand.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr, Charset charset) {
        if (StringCommand.isEmpty(hexStr)) {
            return hexStr;
        }
    ...
    public static String decodeHexStr(char[] hexData, Charset charset) {
        return StringCommand.str(decodeHex(hexData), charset);
    }
