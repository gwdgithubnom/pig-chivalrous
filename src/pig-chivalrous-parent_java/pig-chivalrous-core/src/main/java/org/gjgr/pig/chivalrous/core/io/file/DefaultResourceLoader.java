 ...
 * class for {@links org.springframework.context.support.AbstractApplicationContext}. Can also be used standalone.
 *
 * <p>
 * Will return a {@links UrlResource} if the location value is a URL, and a {@links ClassPathResource} if it is a
...
public class DefaultResourceLoader implements ResourceLoader {
    ...
    public DefaultResourceLoader() {
        this.classLoader = ClassCommand.getDefaultClassLoader();
    }
    ...
    /**
     * Obtain a cache for the given value type, keyed by {@links Resource}.
     *
     * @param valueType the value type, e.g. an ASM {@code MetadataReader}
     * @return the cache {@links Map}, shared at the {@code ResourceLoader} level
     * @since 5.0
     */
    ...
    public Resource getResource(String location) {
        ...
        if (location.startsWith("/")) {
            ...
            try {
                ...
                return (FileCommand.isFileURL(url) ? new FileUrlResource(url) : new UrlResource(url));
    ...
    public ClassLoader getClassLoader() {
        return (this.classLoader != null ? this.classLoader : ClassCommand.getDefaultClassLoader());
    }
     ...
     * @sees ClassPathResource
     * @sees org.springframework.context.support.FileSystemXmlApplicationContext#getResourceByPath
     * @sees org.springframework.web.context.support.XmlWebApplicationContext#getResourceByPath
     */
    ...
    protected static class ClassPathContextResource extends ClassPathResource implements ContextResource {
        ...
        public Resource createRelative(String relativePath) {
            String pathToUse = LocationCommand.applyRelativePath(getPath(), relativePath);
