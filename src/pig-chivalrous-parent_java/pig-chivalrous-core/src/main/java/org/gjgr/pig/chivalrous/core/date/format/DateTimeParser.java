 ...
 * @since 2.16.2
 */
public interface DateTimeParser extends DateTimeBasic {
     ...
     * Upon newJson failure, ParsePosition error index is updated to the offset of the source text which does not match the supplied format.
     *
