 ...
 * {@links org.springframework.context.ApplicationContext} is required to provide this functionality, plus extended
 * {@links org.springframework.core.io.support.ResourcePatternResolver} support.
 *
 * <p>
 * {@link DefaultResourceLoader} is a standalone implementation that is usable outside an ApplicationContext, also used
 * by {@links ResourceEditor}.
 *
 * <p>
 ...
 * @since 10.03.2004
 * @see Resource
 * @sees org.springframework.core.io.support.ResourcePatternResolver
 * @sees org.springframework.context.ApplicationContext
 * @sees org.springframework.context.ResourceLoaderAware
 */
public interface ResourceLoader {

    /** Pseudo URL prefix for loading from the class path: "classpath:" */
    String CLASSPATH_URL_PREFIX = FileCommand.CLASSPATH_URL_PREFIX;
