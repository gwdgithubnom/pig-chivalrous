...
/**
 * @Author gwd
 * @Time 03-15-2019 Friday
 * @Description: developer.tools:
 * @Target:
 * @More:
 */
public class NeedToDoOperationException extends RuntimeException {
    static final long serialVersionUID = -1242599979055084673L;

    /**
     * Constructs an UnsupportedOperationException with no detail message.
     */
    public NeedToDoOperationException() {
    }
     ...
     */
    public NeedToDoOperationException(String message) {
        super(message);
    }
     ...
     * @since 1.5
     */
    public NeedToDoOperationException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.5
     */
    public NeedToDoOperationException(Throwable cause) {
        super(cause);
    }
}
