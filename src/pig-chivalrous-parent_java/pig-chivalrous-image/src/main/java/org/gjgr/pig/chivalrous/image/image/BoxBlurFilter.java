...
/**
 * A filter which performs a box blur on an image. The horizontal and vertical blurs can be specified separately and a
 * number of iterations can be given which allows an approximation to Gaussian blur.
 */
