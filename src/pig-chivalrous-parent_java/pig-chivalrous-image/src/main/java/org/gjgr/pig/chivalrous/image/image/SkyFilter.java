...
import org.gjgr.pig.chivalrous.image.math.FBM;
...
public class SkyFilter extends PointFilter {
    ...
    public int filterRGB(int x, int y, int rgb) {
        ...
        // Bump map
        /*
         * float nnx = x-cx; float nny = y-1; nnx /= xscale; nny /= xscale * stretch; float gf = evaluate(nnx, nny);
         * float gradient = fg-gf; if (y == 100)System.out.println(fg+" "+gf+gradient); cloudColor += amount * gradient;
         */
        // ...
        /*
         * r += (cloudColor-r) * cloudAlpha; g += (cloudColor-g) * cloudAlpha; b += (cloudColor-b) * cloudAlpha;
         */
